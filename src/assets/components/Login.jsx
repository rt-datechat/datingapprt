          ...
          <div className="mt-10">
            <form action="#" onSubmit={handleLogin}>
              <div className="flex flex-col mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="email"
                    name="email"
                    className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-3xl border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400"
              ...
              <div className="flex w-full">
                <button
                  type="submit"
                  className="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-[#9ab7d4]
                  hover:bg-[#81b0df] rounded py-2 w-full transition duration-150 ease-in"
                >
